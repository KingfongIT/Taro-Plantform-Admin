...
const serverItems = computed(() => {
  ...
  rawData.value.forEach((item) => {
    ...
    grouped[key].peer += item.peer
    grouped[key].super += item.super
    grouped[key].management += item.management
...
async function fetchData() {
  ...
  try {
    ...
    console.log(data)
    rawData.value = data.commissions
    totalItems.value = data.commissions.length
